...
#devtools::install_github("HakaiInstitute/hakaiR")
     ...
     # Survey Data
survey_seines <- read_csv(here("report_data", "survey_seines.csv")) %>%
  rename("Sockeye" = "so_total", "Pink" = "pi_total", "Chum" = "cu_total")
sealice_summary_table <- read_csv(here("report_data", "sealice_summary_table.csv"))
lice_bootstraps <- read_csv(here("report_data", "lice_bootstraps.csv"))
# Temp processed_data
ctd_all <- read_csv(here("report_data", "ctd_all.csv"))
temperature_anomaly_data <- read_csv(here("report_data", "temperature_anomaly_data.csv"))
min_max_data <- read_csv(here("report_data", "min_max_temps.csv"))
average_temps <- read_csv(here("report_data", "average_temps.csv"))
proportion <- read_csv(here("report_data", "proportion.csv"))
# Migration Timing processed_data
predict_average_prop <- read_csv(here("report_data", "predict_average_prop.csv"))
predict_annual_prop <- readRDS(here("report_data", "predict_annual_prop.RDS"))
peak_dates <- read_csv(here("report_data", "peak_dates.csv"))
catch_intensity <- read_csv(here("report_data", "catch_intensity.csv"))
# I can't get 2017 chum logistic growth line (beause we didn't capture of the migration) so I use points instead
cu_cum_abund_annual_DI_2017 <- read_csv(here("report_data", "cu_cum_abund_DI_2017.csv"))
# Length processed_data
length_histo <- read_csv(here("report_data", "length_histo.csv"))
fish_cond <- read_csv(here("report_data", "fish_cond.csv"))
...
heatmap_data <- readRDS(here("report_data", "heatmap_data.RDS"))
...
tsa_length <- summary_lengths %>% 
  ...
  select(Year, Species, n, "Fork Length (mm)", "95% CI")
...
ggplot(data = df, aes(x = year, y = mean_abund, fill = louse_species)) +
      geom_bar(colour = "black", stat = "identity", position = position_dodge()) +
