...
bycatch <- read_csv(here("tidy_data", 'bycatch_mort.csv'))
...
write_csv(event, here::here("OBIS_data", "event.csv"))
```
...
unique_bycatch <- unique(bycatch_occ$scientificName) %>%  glimpse()
...
write_csv(occurrence, here::here("OBIS_data", "occurrence.csv"))
