...
This script is meant to read in the tidy data from the Hakai Juvenile Salmon Program, and filters data to something that permit inter-annual comparison of the key migration variables. 
...
sites <- read_csv(here("tidy_data", "sites.csv"))

survey_data <- read_csv(here("tidy_data", "survey_data.csv")) %>% 
  left_join(sites, by = 'site_id')

seine_data <- read_csv(here("tidy_data", "seine_data.csv"))
...
write_csv(survey_seines, here::here("report_data", "survey_seines.csv"))
saveRDS(survey_seines,  here::here("report_data", "survey_seines.RDS"))
...
sealice_time_series <- read_csv(here("tidy_data", "combined_motile_lice.csv")) %>%
...
write_csv(sealice_time_series, here("report_data", "sealice_time_series.csv"))
saveRDS(sealice_time_series,  here::here("report_data", "sealice_time_series.RDS"))
...
readr::write_csv(lice_bootstraps, here("report_data", "lice_bootstraps.csv"))
saveRDS(lice_bootstraps,  here::here("report_data", "lice_bootstraps.RDS"))
...
write_csv(catch_intensity, here::here("report_data", "catch_intensity.csv"))
saveRDS(catch_intensity,  here::here("report_data", "catch_intensity.RDS"))
```
...
write_csv(predict_average_prop,
          here::here("report_data", "predict_average_prop.csv"))
saveRDS(predict_average_prop, here::here("report_data", "predict_average_prop.RDS"))
...
write_csv(cu_cum_abund_annual_DI_2017, here("report_data", "cu_cum_abund_DI_2017.csv"))
saveRDS(cu_cum_abund_annual_DI_2017, here::here("report_data", "cu_cum_abund_annual_DI_2017.RDS"))          
...
# For now, I'll fjust use raw points without a line
write_csv(cu_cum_abund_2017, here("report_data", "cu_cum_abund_2017.csv"))
saveRDS(cu_cum_abund_2017, here::here("report_data", "cu_cum_abund_2017.RDS"))
...
write_csv(predict_annual_prop, here::here("report_data", "predict_annual_prop.csv"))
saveRDS(predict_annual_prop, here::here("report_data", "predict_annual_prop.RDS"))
...
write_csv(peak_dates, here("report_data","peak_dates.csv"))
saveRDS(peak_dates, here::here("report_data", "peak_dates.RDS"))
```

```{r Lengths and Condition}

fish_lab_data <- read_csv(here("tidy_data", "fish_lab_data.csv"), guess_max = 10000)
...
saveRDS(length_histo, here::here("report_data", "length_histo.RDS"))
write_csv(length_histo, here::here("report_data", "length_histo.csv"))
...
write_csv(fish_cond, here("report_data", "fish_cond.csv"))
saveRDS(fish_cond, here("report_data", "fish_cond.RDS"))
```
...
write_csv(proportions, here::here("report_data", "proportion.csv"))
saveRDS(proportions, here::here("report_data", "proportion.RDS"))
...
qu39_all <- client$get(paste0(client$api_root, "/ctd/views/file/cast/data?fields=start_dt,station,conductivity,temperature,depth,salinity,dissolved_oxygen_ml_l&start_dt.year>2014&station=QU39&start_dt.doy>32&start_dt.doy<213&depth<=30&limit=-1"))
...
write_csv(qu39, here::here("report_data", "ctd_all.csv"))
saveRDS(qu39, here::here("report_data", "ctd_all.RDS"))
...
saveRDS(min_max_data,  here::here("report_data", "min_max_temps.RDS"))
write_csv(min_max_data,  here::here("report_data", "min_max_temps.csv"))

average_temps <- qu39_average
saveRDS(average_temps, here::here("report_data", "average_temps.RDS"))
write_csv(average_temps, here::here("report_data", "average_temps.csv"))

temperature_anomaly_data <- qu39_temp_anomaly_data
saveRDS(temperature_anomaly_data,
        here::here("report_data", "temperature_anomaly_data.RDS"))
write_csv(temperature_anomaly_data,
          here::here("report_data", "temperature_anomaly_data.csv"))
...
write_csv(heatmap_data, here("report_data", "heatmap_data.csv"))
saveRDS(heatmap_data, here("report_data", "heatmap_data.RDS"))
