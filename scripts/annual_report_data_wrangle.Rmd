...
write_csv(sealice_summary_table, here("report_data", "sealice_summary_table.csv"))
saveRDS(sealice_summary_table,  here::here("report_data", "sealice_summary_table.RDS"))
```
