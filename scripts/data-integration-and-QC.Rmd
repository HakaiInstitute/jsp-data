...
bycatch_mort <- bycatch_mort[rep(seq.int(1, nrow(bycatch_mort)), bycatch_mort$bm_count), 1:4] %>%
...
#TODO: As Brian if there any isotope sample results, if so add them here!
...
knitr::kable(fish_k)#Anything outside this range is suspect, though U1087 seems legit and has been double checked.
