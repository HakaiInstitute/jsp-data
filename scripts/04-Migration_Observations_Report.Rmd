...
Ocean temperature in the top 30 m of the water column in May and June during the juvenile salmon out-migration at QU39 in the northern Strait of Georgia was  `r round(sst_stats_table[1,2],1)` °C, `r round(sst_stats_table$estimate, 2)` `r ifelse(sst_stats_table$estimate > 0,  paste("warmer"), paster("colder"))` °C than average.
...
ggsave(here("figs", "lengths.png"), width = 8, height = 7)
```
