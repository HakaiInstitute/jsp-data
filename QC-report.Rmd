...
#TODO: improve the outputs of QC checks to be in tables or plots and out of inline text sentences.
```
...
n_fish_no_latlon <- sum(is.na(survey_seines_fish$lat))
...
knitr::kable(quality_comments, caption = "Table 3. Fish quality log comments grouped by the first four words and counted by that group")
```
