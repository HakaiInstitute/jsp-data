...
qu39_ctd <- read_csv(here("supplemental_materials", "tidy_data", "ctd_all.csv")) %>% 
  filter(station == "QU39",
         depth <= 30) %>% 
...
write_csv(qu39, here::here("supplemental_materials", "report_data", "ctd_all.csv"))
saveRDS(qu39, here::here("supplemental_materials", "report_data", "ctd_all.RDS"))
