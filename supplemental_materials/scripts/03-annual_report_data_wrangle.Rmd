...
qu39_ctd <- read_csv(here("tidy_data", "ctd_all.csv")) %>% 
  filter(station == "QU39",
         depth <= 30)
  mutate(year = as.character(substr(time,1,4)),
         date = sub(".*_", "", hakai_id),
         yday = yday(date),
         week = week(date)
  )
...
qu39_temp_anomaly_data <-
  ...
  #   station = "QU39",
  #   yday = (124 + 139) / 2,
  #   predicted_mean_temp = predict(temp.lo_qu39, (124 + 139) / 2),
  #   mean_temp = predict(temp.lo_qu39, (124 + 139) / 2)
  # )
