...
qu39_temp_anomaly_data <-
  ...
  add_row(
    yday = (50 + 54) / 2,
    predicted_mean_temp = predict(temp.lo_qu39, (50 + 54) / 2),
    mean_temp = predict(temp.lo_qu39, (50 + 54) / 2)
  ) %>% 
  add_row(
    yday = (140 + 148) / 2,
  ...
  add_row(
    yday = (203 + 208) / 2,
    predicted_mean_temp = predict(temp.lo_qu39, (203 + 208) / 2),
    mean_temp = predict(temp.lo_qu39, (203 + 208) / 2)
  )
