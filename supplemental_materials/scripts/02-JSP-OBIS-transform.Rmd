...
measurementOrFact <- bind_rows(measurementOrFact, emof_ysi)

write_csv(measurementOrFact, here::here("supplemental_materials", "OBIS_data", "extendedMeasurementOrFact.csv"))
