...
#TODO collapse not retained fish in the occurrence table and add number caught as organismQuantity, organismQuantityType, organismQuanityRemarks, annd differentiate between 2015 2016 visual estimates and latter clicker counts

#TODO add organismQuantity and organismQuantityType to retained/measured fish
...
ocgy_coords <- event |> 
  distinct(locationID) |> 
  left_join(sites, by = c("locationID" = "site_id")) |> 
...
map_coords <- left_join(ocgy_coords, avg_coords) |> 
