...
qu39_all <- client$get(paste0(client$api_root, 
                              "/ctd/views/file/cast/data?fields=start_dt,station,conductivity,temperature,depth,salinity,dissolved_oxygen_ml_l&start_dt.year>2014&station=QU39&start_dt.doy>32&start_dt.doy<213&depth<=30&limit=-1"))
