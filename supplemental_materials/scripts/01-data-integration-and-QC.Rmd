...
source(here::here("supplemental_materials", "scripts", "all_stages_sealice_integration.R"))
# Restart session after sourcing
...
test <- read_csv(here("jsp_catch_and_bio_data_complete.csv"))
problems()
print(problems(), n = 29)
rm(test)
```
